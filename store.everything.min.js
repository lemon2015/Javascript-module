...
!function (t) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = t(); else if ("function" == typeof define) define([], t); else {
        var e;
    ...
    return function t(e, n, r) {
        ...
        1: [function (t, e, n) {
        ...
        }, {"../plugins/all": 2, "../src/store-engine": 13, "../storages/all": 15}], 2: [function (t, e, n) {
            "use strict";
            e.exports = [t("./defaults"), t("./dump"), t("./events"), t("./observe"), t("./expire"), t("./json2"), t("./operations"), t("./update"), t("./v1-backcompat")]
        }, {
            "./defaults": 3,
            "./dump": 4,
            "./events": 5,
            ...
            function r() {
                ...
                var c = o();
                return {watch: t, unwatch: e, once: n, set: r, remove: i, clearAll: s}
            }
            ...
            var i = t("../src/util"), u = i.bind, a = i.each, s = i.create, c = i.slice;
            e.exports = r;
            var f = {
        ...
        }, {"../src/util": 14}], 6: [function (t, e, n) {
            "use strict";
            function r() {
                function t(t, e, n, r) {
                    return this.hasNamespace(o) || a.set(e, r), t()
                }
                ...
                function n(t, e) {
                    return this.hasNamespace(o) || a.remove(e), t()
                }
                ...
                function u(t) {
                    var e = a.get(t, Number.MAX_VALUE);
                    e <= (new Date).getTime() && (this.raw.remove(t), a.remove(t))
                }

                var a = this.createStore(this.storage, null, this._namespacePrefix + o);
                    ...
                    switch (s && "object" === ("undefined" == typeof s ? "undefined" : _typeof(s)) && "function" == typeof s.toJSON && (s = s.toJSON(t)), "function" == typeof rep && (s = rep.call(e, t, s)), "undefined" == typeof s ? "undefined" : _typeof(s)) {
                        ...
                        case"object":
                            ...
                            if (gap += indent, u = [], "[object Array]" === Object.prototype.toString.apply(s)) {
                                for (i = s.length, n = 0; n < i; n += 1)u[n] = str(n, s) || "null";
                                return o = 0 === u.length ? "[]" : gap ? "[\n" + gap + u.join(",\n" + gap) + "\n" + a + "]" : "[" + u.join(",") + "]", gap = a, o
                            }
                            if (rep && "object" === ("undefined" == typeof rep ? "undefined" : _typeof(rep)))for (i = rep.length, n = 0; n < i; n += 1)"string" == typeof rep[n] && (r = rep[n], o = str(r, s), o && u.push(quote(r) + (gap ? ": " : ":") + o)); else for (r in s)Object.prototype.hasOwnProperty.call(s, r) && (o = str(r, s), o && u.push(quote(r) + (gap ? ": " : ":") + o));
                            return o = 0 === u.length ? "{}" : gap ? "{\n" + gap + u.join(",\n" + gap) + "\n" + a + "}" : "{" + u.join(",") + "}", gap = a, o
                    }
                }
            ...
            function r() {
                ...
                function i(t, e, n, r, i, s) {
                    ...
                    return this.update(e, {}, function (t) {
                        ...
                        return c.unshift(t), a.apply(Object, c)
                    })
                }
            ...
            var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
                ...
                return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
            }, i = t("../src/util"), u = i.slice, a = i.assign, s = t("./update");
            e.exports = [s, r]
        }, {"../src/util": 14, "./update": 11}], 11: [function (t, e, n) {
            "use strict";
            function r() {
                function t(t, e, n, r) {
            ...
            var l = t("./dump"), p = t("./json2");
            e.exports = [l, p, r]
        }, {"./dump": 4, "./json2": 7}], 13: [function (t, e, n) {
            "use strict";
            function r() {
            ...
            function o(t, e, n) {
                ...
                var o = n ? "__storejs_" + n + "_" : "", i = n ? new RegExp("^" + o) : null, g = /^[a-zA-Z0-9_\-]*$/;
                ...
                var v = {
                    _namespacePrefix: o, _namespaceRegexp: i, _testStorage: function (t) {
                        ...
                        this[e] = function () {
                            ...
                            var r = u(arguments, 0), o = this, i = [e].concat(r);
                            return t.apply(o, i)
                        }
                        ...
                        var n = a(this.plugins, function (e) {
                            return t === e
                        });
                        if (!n) {
            ...
            var i = t("./util"), u = i.slice, a = i.pluck, s = i.each, c = i.bind, f = i.create, l = i.isList,
                p = i.isFunction, d = i.isObject;
            e.exports = {createStore: o};
            var h = {
                version: "2.0.10", enabled: !1, get: function (t, e) {
        ...
        }, {"./util": 14}], 14: [function (t, e, n) {
            (function (t) {
                "use strict";
                function n() {
                    return Object.assign ? Object.assign : function (t, e, n, r) {
                        for (var o = 1; o < arguments.length; o++)a(Object(arguments[o]), function (e, n) {
                            t[n] = e
                        });
                        return t
                    }
                ...
                function r() {
                    if (Object.create)return function (t, e, n, r) {
                        var o = u(arguments, 1);
                        return d.apply(this, [Object.create(t)].concat(o))
                    };
                    var t = function () {
                    };
                    return function (e, n, r, o) {
                        var i = u(arguments, 1);
                        return t.prototype = e, d.apply(this, [new t].concat(i))
                    }
                }
                ...
                var d = n(), h = r(), g = o(), v = "undefined" != typeof window ? window : t;
                e.exports = {
                    assign: d,
                    create: h,
                    trim: g,
            ...
            function u(t) {
                t && s(t) && (p.cookie = escape(t) + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/")
            }
            ...
            var c = t("../src/util"), f = c.Global;
            e.exports = {name: "localStorage", read: o, write: i, each: u, remove: a, clearAll: s}
        }, {"../src/util": 14}], 18: [function (t, e, n) {
            "use strict";
            function r(t) {
                return s[t]
            }
            ...
            function c() {
                ...
                try {
                    ...
                    n = d.createElement("div"), t = d.body
                }
                return function (e) {
            ...
            var c = t("../src/util"), f = c.Global;
            e.exports = {name: "sessionStorage", read: o, write: i, each: u, remove: a, clearAll: s}
        }, {"../src/util": 14}]
    }, {}, [1])(1)
});