!function e(t, n, o) {
    ...
    1: [function (e, t, n) {
        t.exports = {errorlogPath: "log.sobot.com/errorlog/"}
    }, {}],
    2: [function (e, t, n) {
        !function (e, o) {
            Array.prototype.map || (Array.prototype.map = function (e, t) {
                ...
                for (t && (n = t), o = new Array(a), r = 0; r < a;) {
                    var c, s;
                    r in i && (c = i[r], s = e.call(n, c, r, i), o[r] = s), r++
                }
                return o
            });
            var r = e.detect = function () {
                ...
                var n = Array.prototype, o = (Object.prototype, Function.prototype, n.forEach),
                    r = (n.indexOf, function (e, t) {
                        ...
                        if (null != e)if (o && e.forEach === o) e.forEach(t, n); else if (e.length === +e.length)for (var r = 0, i = e.length; r < i; r++)t.call(n, e[r], r, e); else for (var a in e)_.has(e, a) && t.call(n, e[a], a, e)
                    }, c = function (e) {
                        return !(!e || "undefined" == typeof e || null == e)
                    }, s = function (e) {
                        var t = "";
                        return e = e || {}, c(e) && c(e.major) && (t += e.major, c(e.minor) && (t += "." + e.minor, c(e.patch) && (t += "." + e.patch))), t
                    }, l = function (e) {
                        e = e || {};
                        var t = s(e);
                        return t && (t = " " + t), e && c(e.family) ? e.family + t : ""
                    };
                return e.parse = function (t) {
                    var n = function (t) {
                        return e.regexes[t + "_parsers"].map(function (e) {
                            ...
                            var o = new RegExp(e.regex), r = e[("browser" === t ? "family" : t) + "_replacement"],
                                i = e.major_version_replacement;
                            return n
                        })
                    }, o = function () {
                    }, a = n("browser"), d = n("os"), u = n("device"), m = new o;
                    m.source = t, m.browser = r(t, a), c(m.browser) ? (m.browser.name = l(m.browser), m.browser.version = s(m.browser)) : m.browser = {}, m.os = r(t, d), c(m.os) ? (m.os.name = l(m.os), m.os.version = s(m.os)) : m.os = {}, m.device = r(t, u), c(m.device) ? (m.device.name = l(m.device), m.device.version = s(m.device)) : m.device = {
                        tablet: !1,
                        family: "Other"
                    };
                    var p = {};
    ...
    4: [function (e, t, n) {
        var o = function () {
            var e;
            if (window.XMLHttpRequest) e = new XMLHttpRequest, e.overrideMimeType && e.overrideMimeType("text/xml"); else if (window.ActiveXObject)for (var t = ["MSXML2.XMLHTTP", "Microsoft.XMLHTTP"], n = 0; n < t.length; n++)try {
            ...
            var o = t.type || "get", i = r(t.data, o), c = t.url || "";
            "get" == o && (c += "?" + i), e.open(o.toUpperCase(), c, !0), "post" == o.toLowerCase() ? (e.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), a(e, t.headers), e.send(i)) : "get" == o.toLowerCase() && (a(e, t.headers), e.send()), e.onreadystatechange = function () {
            ...
            var t = {}, n = document.createElement("script"), o = r(e.data, "get"), i = e.url || "";
            i += "?" + o, i += "&";
            var a = +new Date, l = "callback" + a;
            i += "callback=" + l;
            var d;
            ...
            }, n.src = i, document.body.appendChild(n), t.success = c, t.fail = s, t
        }, d = function (e) {
            if (e.dataType && "jsonp" === e.dataType.toLowerCase())return l(e);
            var t = {}, n = o();
            return i(n, e, t), t.success = c, t.fail = s, t
        }, u = function () {
    ...
    6: [function (e, t, n) {
        !function () {
            ...
            function n(e, t, o) {
                return ("string" == typeof t ? t : t.toString()).replace(e.define || c, function (t, n, r, i) {
            ...
            i.template = function (t, r, s) {
                r = r || i.templateSettings;
                var l, d, u = r.append ? a.append : a.split, m = 0;
                t = r.use || r.define ? n(r, t, s || {}) : t, t = ("var out='" + (r.strip ? t.replace(/(^|\r|\n)\t* +| +\t*(\r|\n|$)/g, " ").replace(/\r|\n|\t|\/\*[\s\S]*?\*\//g, "") : t).replace(/'|\\/g, "\\$&").replace(r.interpolate || c, function (e, t) {
                    return u.start + o(t) + u.end
                }).replace(r.encode || c, function (e, t) {
                    return l = !0, u.start + o(t) + u.endencode
                }).replace(r.conditional || c, function (e, t, n) {
                    return t ? n ? "';}else if(" + o(n) + "){out+='" : "';}else{out+='" : n ? "';if(" + o(n) + "){out+='" : "';}out+='"
                }).replace(r.iterate || c, function (e, t, n, r) {
                    return t ? (m += 1, d = r || "i" + m, t = o(t), "';var arr" + m + "=" + t + ";if(arr" + m + "){var " + n + "," + d + "=-1,l" + m + "=arr" + m + ".length-1;while(" + d + "<l" + m + "){" + n + "=arr" + m + "[" + d + "+=1];out+='") : "';} } out+='"
                }).replace(r.evaluate || c, function (e, t) {
                    return "';" + o(t) + "out+='"
    ...
    7: [function (e, t, n) {
        var o, r = {}, i = e("../config/config.json"), a = e("../lib/detect.js"), c = encodeURIComponent,
            s = /Mobile/.test(window.navigator.userAgent) ? "wap" : "pc", l = function (e, t, n, r) {
                var a = new Image, l = "error=" + c(e.toString());
                l += "&stack=" + c(e.stack), l += "&from=" + t, l += "&os=" + o.os.family, l += "&osVersion=" + o.os.version, l += "&browser=" + o.browser.family, l += "&browserVersion=" + o.browser.version, l += "&type=" + s, l += "&uid=" + r.apiInit.uid, l += "&data=" + c(JSON.stringify(n)), l += "&pid=" + r.apiInit.pid, a.src = "//" + i.errorlogPath + "runtime?" + l
            }, d = function (e, t, n, o) {
                new Image;
                $.ajax({
                    ...
                    type: "post",
                    dataType: "json",
                    data: {errorType: e, from_type: t, data: c(JSON.stringify(n)), pid: o.apiInit.pid, type: s}
                })
            }, u = function (e, t, n, o, r, a) {
                var l = new Image, d = [];
                d.push("url=" + c(t)), d.push("data=" + c(JSON.stringify(n))), d.push("pid=" + a.apiInit.pid), d.push("duration=" + c(o)), d.push("uid=" + c(a.apiInit.uid)), d.push("type=" + s), d.push("reqType=" + r);
                var u = d.join("&");
                l.src = "//" + i.errorlogPath + "overtime?" + u
            }, m = function (e, t, n, o, r) {
                var a = new Image, l = [];
                l.push("status=" + e.status), l.push("statusText=" + e.statusText), l.push("url=" + c(t)), l.push("data=" + c(JSON.stringify(n))), l.push("pid=" + r.apiInit.pid), l.push("responseText=" + c(e.responseText)), l.push("type=" + s), l.push("uid=" + c(r.apiInit.uid)), l.push("reqType=" + o);
                var d = l.join("&");
        ...
        !function () {
            var e = window.navigator.userAgent;
            o = a.parse(e)
        }(), r.networkError = m, r.runtimeError = l, r.overTimeError = u, r.specialError = d, r.init = function () {
        }, r.getFlag = function () {
            return !1
        }, t.exports = r
    }, {"../config/config.json": 1, "../lib/detect.js": 2}],
    8: [function (e, t, n) {
        function o(e, t) {
            var t = t || 0;
            if ("object" != typeof e)throw"not a json";
            var n = Object.prototype.toString.call(e), r = "";
            if (/Array/.test(n)) {
                r = "[";
            ...
            if (/Object/.test(n)) {
                ...
                for (var p in e)if (e.hasOwnProperty(p)) {
                    if ("number" == typeof e[p]) l = "", m > 0 && (l += ","), l += '"' + p + '":' + e[p], i.push(l); else if ("boolean" == typeof e[p]) l = "", m > 0 && (l += ","), l += '"' + p + '":' + e[p], i.push(l); else if ("string" == typeof e[p]) l = "", m > 0 && (l += ","), l += '"' + p + '":"' + e[p] + '"', i.push(l); else if ("object" == typeof e[p]) {
                        l = "";
                        try {
    ...
    9: [function (require, module, exports) {
        function init() {
            ...
            window.JSON || (window.JSON = {parse: parse, stringify: stringify})
        }
    ...
    10: [function (e, t, n) {
        var o = {}, r = {}, i = function (e, t) {
            if (r[e])for (var n = 0, o = r[e].length; n < o; n++) {
                var i = r[e][n];
                i(t)
            }
        }, a = function (e, t) {
            r[e] || (r[e] = []);
            for (var n = !1, o = r[e], i = 0, a = o.length; i < a; i++)if (o[i] == t) {
                n = !0;
                break
            }
            n || r[e].push(t)
            ...
            if (t && "function" == typeof t) {
                var n = r[e];
                if (n && n.length)for (var o = n.length, i = o - 1; i >= 0; i--) {
                    var a = n[i];
                    if (a == t) {
                        n.splice(i, 1);
                        break
        ...
        o.on = a, o.off = c, o.trigger = i, t.exports = o
    }, {}],
    11: [function (e, t, n) {
        var o = {
            doc: document, timer: null, oldTitle: "", flashFlag: !1, count: 0, msg: "您有【新消息】", flash: function () {
    ...
    12: [function (e, t, n) {
        function o() {
            ...
            this.resolve = function (n) {
                ...
                return e.push({success: n, fail: o}), t
            }
        }
    ...
    13: [function (e, t, n) {
        function o(e) {
            ...
            for (var n = t.split("&"), o = {}, r = 0; r < n.length; r++) {
                var i = n[r], a = i.substring(0, i.indexOf("=")), c = i.substring(i.indexOf("=") + 1);
                /^-?(\d+)(\.\d+)?$/.test(c) ? ("" + c).length > 10 ? o[a] = "" + c : o[a] = Number(c) : "true" === c ? o[a] = !0 : "false" === c ? o[a] = !1 : o[a] = c
            }
            return o
        }
    ...
    14: [function (e, t, n) {
        t.exports = {
            staticPath: "//www.sobot.com/chat/{type}/index.html",
    ...
    15: [function (e, t, n) {
        function o(t) {
            var n, o, r, i, a, c, s, l,
                d = (e("../../../common/util/queryParam.js"), e("../../../common/util/listener.js")),
                u = (e("../../../common/util/cookie.js"), e("../fun/event.js")),
                m = e("../../../common/util/addEvent.js"), p = e("../fun/trace.js"),
                f = (e("../fun/logGif.js"), e("../socket/socketFactory.js")),
                g = (e("../util/move.js"), e("../../../common/util/doT.min.js")), h = e("./invite.js"),
                x = e("../fun/unRead.js"), v = "zhichiScript", b = {}, y = e("../config/config.json"), w = !1, T = !1,
                S = navigator.userAgent.indexOf("Mobile") >= 0, _ = e("../../../common/util/ajax.js"),
                k = e("../template/template.js"), M = e("./frame.js"), j = e("../fun/theme.js"),
                C = (e("../fun/utm.js"), e("../fun/bubble.js")), A = e("../fun/invite.js"), I = !1, O = [], B = 0,
                z = [], P = {}, N = "collapse",
                E = ["partnerId", "color", "sysNum", "from", "back", "lan", "telShowFlag", "telFlag", "emailShowFlag", "emailFlag", "satDegree", "invite", "artificial", "moduleType", "powered", "satDegree_A", "cid", "groupId", "source", "robotFlag", "isLeaveMsgFlag", "msgflag", "isMessageFlag", "isFeedBackFlag", "time", "titleFlag", "customTitle", "isReComment", "wurl", "isCustomSysFlag", "aid", "tranFlag", "evaluateFlag", "title_info", "url_info", "abstract_info", "label_info", "thumbnail_info", "customerFields", "robotHelloWord", "adminHelloWord", "adminTipWord", "userTipWord", "adminNonelineTitle", "visitStartTime", "leaveMsgSendGroupIdFlag", "ticketTypeFlag", "ticketTypeId"],
                L = ["tel", "email", "uname", "visitTitle", "visitUrl", "face", "realname", "weibo", "weixin", "qq", "sex", "birthday", "remark", "params", "uid"],
                F = {ISaveUserData: "//" + y.domain + "/chat/user/humanInfo.action"}, W = function (e) {
                    202 == e.type ? (l.receiveUnReadCountFromSocket(1), o && o.send({
                        name: "offlineMessage",
                        data: e
                    }), o && "expand" == N ? l.clearRead() : "collapse" === N && u.trigger("receivemessage", {
                            data: [{
                                content: e.content || "",
                                customName: e.aname || "",
                                msgId: e.msgId || ""
                            ...
                            type: "auto",
                            aid: e.aid
                        })) : (te("autoManual", !0), te("aid", e.aid)), "collapse" == N && G())
                }, Z = function (e) {
                    var r;
                    if ("string" == typeof e.data)try {
                        r = JSON.parse(e.data)
                    } catch (a) {
                    } else"object" == typeof e.data && (r = e.data);
                    if (Object.prototype.toString.call(r).indexOf("object Object") >= 0 && r) "init" == r.name ? i && (i.style.backgroundColor = "#" + t.color) : "manual" == r.name ? n && (n.close(), f.clear()) : "closeSession" == r.name && (i.style.backgroundColor = "#ccc", 6 == r.status ? (document.getElementById("zhichiCount").style.display = "none ", document.getElementById("bubbleMsg").style.display = "none") : n = f.getInstance(t)); else {
                        if (/^message\^/.test(r)) {
                            var c = r.replace(/^message\^/, ""), s = JSON.parse(c);
                            return void K(s)
                        }
                        switch (r) {
                            case"zhichiOut":
                    ...
                    for (var t = [], n = a, o = 0, r = n.length; o < r; o++) {
                        var i = n[o];
                        if ("script" != i.tagName.toLowerCase())for (var c = $(i), s = 0; s < c.length; s++)if (c[s] === e) {
                            t.push(i);
                            break
                        }
                    }
                    ...
                    for (var e = $(r), n = [], o = 0, i = e.length; o < i; o++) {
                        var a, c = e[o];
                        "querySelectorAll" in document ? a = document.querySelectorAll("." + c) : ("getElementsByClassName" in document, a = H(c));
                        for (var s = a.length; o < s; o++)n.push(a[o])
                    }
                    for (var o = 0, i = n.length; o < i; o++)"script" !== n[o].tagName.toLowerCase() && z.push(n[o]);
                    z.length > 0 && (t.customBtn = !0)
                }, V = function () {
                    return N
                }, D = function (e, r) {
                    if (o) {
                        var a = s.get("margin");
                        a > 2 ? [s.get("width")] : [s.get("height")];
                        o.send({name: N}), "collapse" == N ? (S || i.firstChild.childNodes[0].setAttribute("src", "//www.sobot.com/chat/pc/img/zhichichatBtnBg1.png"), o.collapse(function () {
                            u.trigger("core.framestatuschange", N), r && r()
                            ...
                            u.trigger("core.framestatuschange", N), setTimeout(l.clearRead, 700), r && r()
                        }))
                    } else o = new M(t, {
                        onload: function () {
                            o.send({name: N}), "collapse" == N ? S || i.firstChild.childNodes[0].setAttribute("src", "//www.sobot.com/chat/pc/img/zhichichatBtnBg1.png") : (setTimeout(l.clearRead, 500), S || i.firstChild.childNodes[0].setAttribute("src", "//sobot-test.oss-cn-beijing.aliyuncs.com/console/3542411be2184c8cb6b48d66ca1b2730/userandgroup/29dcc1573d524a16b5dfac756e04ba22.JPG")), t.autoManual && n && (n.close(), f.clear())
                        }, onexpaned: function () {
                            w = !1, u.trigger("core.framestatuschange", N), r && r()
                        }
                    }, s.themeConf, "expand" == N)
                }, G = function (e, n) {
                    if (!(w || t.anchor && !S)) {
                        w = !0;
                        var n = n || function () {
                                w = !1, "expand" == N ? (B = 0, c && (c.style.display = "none"), i.style.overflow = "visible") : i.style.overflow = "visible", K([])
                            };
                        if ("collapse" == N ? (N = "expand", u.trigger("bubble.expand", N)) : "expand" == N && (N = "collapse"), window.localStorage)try {
                            window.localStorage.setItem("frameStatus", N)
                        } catch (o) {
                        }
                        D(N, n)
                    }
                    ...
                    if (!I) {
                        ...
                        var e = (document.createDocumentFragment(), document.createElement("div")),
                            n = u ? y.wapDir : y.pcDir, o = y.staticPath.replace(/\{type\}/, n) + "?", r = [],
                            a = s.themeConf.height;
                        for (var l in t)if (t.hasOwnProperty(l)) {
                            E = E || [];
                            for (var d = 0; d < E.length; d++)E[d] == l && r.push(l + "=" + encodeURIComponent(t[l]))
                        }
                        o = r.join("&");
                        var u = navigator.userAgent.indexOf("Mobile") >= 0, p = u ? "touchend" : "click",
                            f = location.hostname.indexOf("www") >= 0 ? "www" : "test",
                            h = location.protocol + "//" + f + ".sobot.com/chat/" + (u ? "h5" : "pc") + "/index.html?";
                        h += o, p = "click";
                        var x = g.template(k.btnTemplate)({
                            anchor: t.anchor,
                            height: t.manual ? "0" : a,
                            tUrl: h,
                            isMobile: u
                        });
                        e.innerHTML = x, i = e.getElementsByTagName("div")[0], s.setTheme(i), c = i.getElementsByTagName("i")[0], document.body.appendChild(i), z.length > 0 && (i.style.display = "none"), m(i, p, G)
                    }
                }, J = function () {
                    ...
                    if ("expand" != N) {
                        ...
                        B += e.length, B > 0 && c ? (c.innerHTML = B > 99 ? "99+" : B, c.style.display = "block") : c && (c.style.display = "none")
                    }
                }, X = function (e) {
                    N = "expand", D(N, function () {
                        w = !1, B = 0, c.style.display = "none", e && e()
                    })
                }, Y = function () {
                    return O
                }, Q = function (e) {
                    N = "collapse", D(N, function () {
                        w = !1, e && e()
                    })
                }, ee = function () {
                    var e = navigator.userAgent, t = e.toLowerCase().indexOf("opera");
                    t > -1 ? P.browser = "OP" : e.toLowerCase().indexOf("firefox") > -1 ? P.browser = "FF" : e.toLowerCase().indexOf("chrome") > -1 ? P.browser = "CH" : e.toLowerCase().indexOf("safari") > -1 ? P.browser = "SA" : e.toLowerCase().indexOf("compatible") > -1 && e.toLowerCase().indexOf("msie") > -1 && !t && (P.browser = "IE")
                }, te = function (e, n) {
                    if ("string" == typeof e) {
                        if (n !== n || "" === n || void 0 === n)return;
                        t[e] = n, "true" === n ? t[e] = !0 : "false" === n && (t[e] = !1)
                    } else if ("object" == typeof e)for (var o in e)e.hasOwnProperty(o) && (t[o] = e[o]); else"partnerId" == e && (n += "")
                }, ne = function (e, t) {
                    u.on(e, t)
                }, oe = function () {
                    ...
                    if (d.on("core.message", W), z.length > 0) {
                    ...
                    m(window, "message", Z), u.on("inviteSession", re), u.on("bubble.expandFrame", ie), m(window, "unload", function () {
                    })
                }, ce = function () {
                    t.userinfo = t.userinfo || {};
                    for (var e in t)if (t.hasOwnProperty(e)) {
                        for (var n = !1, o = 0; o < L.length; o++)if (L[o] == e) {
                            n = !0;
                            break
                        }
                    ...
                    e = e || {}, _({url: F.ISaveUserData, dataType: "json", type: "POST", data: e}).success(function (e) {
                    }).fail(function (e) {
                    })
                }, le = function () {
                    ee(), s = j(t, function (e) {
                        ...
                        window.localStorage && (a = localStorage.getItem("frameStatus"), 0 == t.ustatus, (0 == t.ustatus && t.autoExpand || t.autoExpand && "expand" == a) && (t.invite = !1, G())), 0 != t.ustatus && ("expand" != a || S ? o = new M(t, {
                            onload: function () {
                                setTimeout(function () {
                                    o.send({name: N})
                                }, 100), "collapse" == N ? S || i.firstChild.childNodes[0].setAttribute("src", "//www.sobot.com/chat/pc/img/zhichichatBtnBg1.png") : S || i.firstChild.childNodes[0].setAttribute("src", "//sobot-test.oss-cn-beijing.aliyuncs.com/console/3542411be2184c8cb6b48d66ca1b2730/userandgroup/29dcc1573d524a16b5dfac756e04ba22.JPG"), t.autoManual && n && (n.close(), f.clear())
                            }
                        }, s.themeConf, "expand" == N) : G()), t.invite && (t.isMobile = S, A(t)), t.manTrace && p(t, 0), l = x(t), 0 == t.ustatus && (n = f.getInstance(t)), h(t), C(t)
            ...
            return setTimeout(function () {
                de()
            }, 10), b.expand = X, b.on = ne, b.init = de, b.setGroupId = U, b.collapse = Q, b.getStatus = V, b.getUnreadChatList = Y, b.set = te, b.initBtnDOM = q, b.userInfoServ = se, b
        }
        ...
        "../fun/unRead.js": 29,
        "../fun/utm.js": 30,
        "../socket/socketFactory.js": 33,
        "../template/template.js": 34,
        "../util/move.js": 36,
        "./frame.js": 16,
        "./invite.js": 17
    }],
    16: [function (e, t, n) {
        function o(t, n, o, r) {
            var i, a, c, s = e("../template/template.js"),
                ...
                z = function (e) {
                    ...
                    d && (i.removeClass(document.body, "ZC-Module-BODY"), i.removeClass(document.documentElement, "ZC-Module-HTML"), c.style.zIndex = -1), d && !t.customBtn && t.dom && (t.dom.style.display = "block"), t.dom && (t.dom.style.backgroundPosition = d ? "13px -63px" : "18px -58px", t.dom.childNodes[0].firstChild.innerHTML = t.title);
                    var e = e || function () {
                        };
                    d ? p.collapseForIframe(c, ["opacity"], function () {
                        c.style.display = "none", u >= 0 ? v.hideZCBar() : b.hideZCBar(), e && e()
                    }) : p.collapse(a, ["height"], [0], function () {
                        a.style.display = "none", e && e()
                    })
                }, Z = function (e) {
                    if (d ? (i.addClass(document.body, "ZC-Module-BODY"), i.addClass(document.documentElement, "ZC-Module-HTML"), c.style.zIndex = +new Date, O.frameWidth = document.body.offsetWidth) : y.clear(), d && !t.customBtn && t.dom && (t.dom.style.display = "none"), t.dom) {
                        t.dom.style.backgroundPosition = d ? "13px -63px" : "18px 28px";
                        var n = "en" === t.lan ? N.L001 : P.L001;
                    ...
                    var o;
                    o = d ? document.documentElement.clientHeight : t.dom.offsetTop < t.size.height && !t.customBtn ? t.dom.offsetTop : t.size.height, d ? p.expandForIframe(c, ["opacity"], ["height", {height: o + "px"}, "opacity", {opacity: 0}], function () {
                        c.style.display = "block", u ? v.showZCBar() : b.showZCBar(), e && e()
                    }) : p.expand(a, ["height"], [o], function () {
                        e && e()
                    }), g.delCookie("msgCount"), t.manTrace && !T && (t.searchSource = 1, h(t, 0), T = !0)
                }, $ = function (e) {
                    var n = e.width || t.width || M, o = e.height || t.height || A;
                    if (n >= k ? n = k : n <= _ && (n = _), o >= C ? o = C : o <= j && (o = j), e = {
                            width: n,
                            height: o
                        }, !t.customBtn) {
                        var r = t.dom.offsetTop - I;
                        r <= A && r >= j ? e.height = r : r < j && (e.height = j)
                    }
                    return e
                }, H = function (e) {
                    e && ("focus-frame" == e.data ? u ? (v.adapter(c, O, t), document.getElementById("ZCChatFrame").style.height = "90%") : b.adapter(c, O, t) : "blur-frame" == e.data && (c.style.bottom = 0, c.style.top = 0, document.getElementById("ZCChatFrame").style.height = "100%"))
                }, R = function () {
                    var e = document.createElement("div"), u = f.template(s.frameTemplate)({isMobile: d});
                    e.innerHTML = u, a = e.getElementsByTagName("iframe")[0], c = e.children[0];
                    var p = d ? m.wapDir : m.pcDir;
                    d ? (a.style.zIndex = +new Date, a.style.cssText += ";right:0px;bottom:0px;") : (t.customBtn ? 1 == (t.location || t.margin) ? (a.style.cssText += ";bottom:0px;right:100px;", t.customMargin && (a.style.cssText += ";right:" + t.customMargin + "px;")) : (a.style.cssText += ";bottom:0px;left:50px;", t.customMargin && (a.style.cssText += ";left:" + t.customMargin + "px;")) : (a.style.cssText += ";bottom:" + (t.vertical + t.dom.offsetWidth + I) + "px;", 1 == t.margin || 4 == t.margin ? a.style.cssText += ";right:" + t.horizontal + "px;" : a.style.cssText += ";left:" + t.horizontal + "px;"), t.size = t.size || {}, t.size = $(t.size), a.style.cssText += ";width:" + t.size.width + "px;");
                    var g = m.staticPath.replace(/{type}/, p) + "?", h = [];
                    t.color = o.color, t.from = "iframe", d && (t.back = 1);
                    for (var v in t)if (t.hasOwnProperty(v)) {
                        if ("userinfo" === v)for (var b in t.userinfo)t.userinfo[b] && h.push(b + "=" + encodeURIComponent(t.userinfo[b])); else if ("object" == typeof t[v])continue;
                        B = B || [];
                        for (var y = 0; y < B.length; y++)B[y] == v && h.push(v + "=" + encodeURIComponent(t[v]))
                    }
                    g += h.join("&"), a.src = g, document.body.appendChild(c), x(a, "load", function (e) {
                        var o = e.target;
            ...
            return G(), S.expand = Z, S.collapse = W, S.reload = E, S.send = L, S.setGroupId = z, S.destroy = F, S
        }
    ...
    17: [function (e, t, n) {
        function o(e) {
            var t = window.navigator.userAgent.indexOf("Mobile") >= 0,
                n = {invite: "//" + i.domain + "/chat/user/visit.action"};
            0 == e.isInvite && r({
                url: n.invite,
                type: "get",
                data: {sysNum: e.sysNum, uid: e.userinfo.uid, source: t ? 4 : 0, title: document.title},
                dataType: "json"
            }).success(function (t) {
                e.visitId = t.visitId
            })
        ...
        var r = e("../../../common/util/ajax.js"), i = e("../config/config.json");
        t.exports = o
    }, {"../../../common/util/ajax.js": 4, "../config/config.json": 14}],
    18: [function (e, t, n) {
        !function () {
            function t(e) {
                if (e != i)throw"zhiSDK can only create by getInstance";
                return c(o)
            }

            var n, o, r = e("../../common/util/queryParam.js"), i = {}, a = "zhichiScript", c = e("./core/core.js");
            ...
            var s = function (e, t) {
                ...
                if (scriptNode = document.getElementById("zhichiScript"), !scriptNode || "string" != typeof scriptNode.tagName || "script" !== scriptNode.tagName.toLowerCase())throw new Error("could get element by #" + a);
                var e = scriptNode.getAttribute("src"), t = scriptNode.getAttribute("data-args") || "";
                s(e, t)
            }, d = function () {
                if (!window.localStorage)throw"您的浏览器版本过低";
                return n || (n = t(i)), n
            };
            l();
            var u = ["51zhishang.com", "tol24.com", "koolearn.com", "koolearn-inc.com", "koocdn.com", "koo.cn", "koopass.com", "sobot.com"];
            if ("23dc13b71a784e9c9962efd10accf7d4" === o.sysNum) {
                for (var m = window.location.host, p = !1, f = 0; f < u.length; f++)if (m.indexOf(u[f]) >= 0) {
                    p = !0;
                    break
                }
                if (!p)return
            }
            o.manual || (n = d(), n.on("load", function (e) {
                n.initBtnDOM()
            })), window.getzhiSDKInstance = d
        }()
    }, {"../../common/util/initJSON.js": 9, "../../common/util/queryParam.js": 13, "./core/core.js": 15}],
    19: [function (e, t, n) {
        var o = e("../../../common/util/addEvent.js"), r = {}, i = !0,
            a = location.hostname.indexOf("www") >= 0 ? "www" : "test", c = {
                iPhone5: {top: 285, "icon-top": 460},
                iPhone6: {top: 285, "icon-top": 559},
                iPhone6p: {top: 300, "icon-top": 629},
                iPhoneSE: {top: 285, "icon-top": 460},
                other: {top: 285, "icon-top": 560}
            }, s = !0, l = function () {
                var e = (navigator.userAgent.toLowerCase(), $(window).width()), t = ($(window).height(), ""), n = 0;
                ...
                var e = document.createElement("div"), t = document.createElement("span"),
                    n = document.createElement("img");
                e.id = "js-zc-icon";
                var o = (document.body.offsetWidth - 60) / 2;
                n.src = d("//{0}.sobot.com/chat/frame/imgs/logo.png", [a]), t.style.cssText += d(";display:block;background-color:#f5f9fa;width:100%;height:25px;position:absolute;top:{0}px;z-index:0;", [c[l()]["icon-top"]]), n.style.cssText += d(";height:20px;position:absolute;top:1px;left:{1}px;", [o]), t.appendChild(n), e.appendChild(t), e.style.cssText += ";position: fixed;bottom:0;top:0;left:0;width:100%;height:100%;z-index:100;background-color:#fff;", document.body.appendChild(e)
            }, h = function () {
                o(document.body, "touchmove", u, !1), o(window, "message", m)
            }, x = function () {
                s && (s = !1, g())
            }, v = function (e, t, n) {
                i = !0, gloabl = n, e.style.width = t.frameWidth + "px", e.style.left = 0, e.style.right = 0, h(), x(), window.scrollTo(0, c[l()].top)
            };
        r.resizeFrame = v, r.showZCBar = p, r.hideZCBar = f, t.exports = r
    }, {"../../../common/util/addEvent.js": 3}],
    20: [function (e, t, n) {
        var o = (e("../../../common/util/addEvent.js"), {}), r = navigator.userAgent.toLowerCase(),
            i = (location.hostname.indexOf("www") >= 0 ? "www" : "test", function () {
                ...
                e.style.top = "", r.indexOf("mz-mx5") >= 0 ? e.style.top = "0" : r.indexOf("mz-m2") >= 0 ? e.style.top = "-45px" : r.indexOf("redmi note 2") >= 0 ? e.style.bottom = "1px" : r.indexOf("huawei_h60") >= 0 ? e.style.bottom = "44px" : r.indexOf("htc_d820") >= 0 ? e.style.top = "-320px" : r.indexOf("mi note") >= 0 ? e.style.bottom = "44px" : r.indexOf("hdh60") >= 0 ? e.style.top = "-20px" : r.indexOf("mqqbrowser") >= 0 && r.indexOf("sm-") >= 0
            };
        o.showZCBar = i, o.hideZCBar = a, o.adapter = c, t.exports = o
    }, {"../../../common/util/addEvent.js": 3}],
    21: [function (e, t, n) {
        var o = function (t) {
            var n, o, r = e("../../../common/util/doT.min.js"), i = e("../template/template.js"),
                a = (e("../fun/unRead.js"), e("../../../common/util/listener.js")),
                c = e("../../../common/util/addEvent.js"), s = e("../fun/event.js"), l = e("../config/config.json"),
                d = e("../../../common/util/msgReminder.js"), u = navigator.userAgent.indexOf("Mobile") > 0, m = 70,
                p = {}, f = function () {
                    var e = r.template(i.bubbleTemplate)({isMobile: u, vertical: u ? m : t.vertical + m}),
                    ...
                    n.innerHTML = e, o = n.getElementsByTagName("iframe")[0], l.funTemplateDir ? o.src = "//" + l.funTemplateDir + "/frame/bubble.html?lan=" + t.lan || "cn" : o.src = "//" + (l.funTemplateDir || l.domain) + "/chat/frame/bubble.html?lan=" + t.lan || "cn", u ? o.style.cssText += ";margin-left:5%;margin-right:5%;width:95%;max-width:95%;" : 1 == t.margin ? (o.style.left = "", o.style.right = t.horizontal - 20 + "px") : o.style.left = t.horizontal + "px", document.body.appendChild(o), o.onload = function () {
                        o.contentWindow.postMessage(JSON.stringify({type: "bubble.onDefalutMsg"}), "*")
                    }
                }, g = function () {
                    t.customBtn ? document.getElementById("bubbleMsg").style.display = "none" : n = document.getElementById("zhichiBtnBox")
                }, h = function () {
                    s.trigger("bubble.expandFrame")
                }, x = function (e) {
                    if (window.localStorage) {
                        var t = window.localStorage.getItem("frameStatus");
                        if ("collapse" == t && e)for (var n = e.data || [], r = 0; r < n.length; r++)"202" == n[r].type && (p = {
                            header: n[r].aface,
                            content: n[r].content,
                            name: n[r].aname,
                            t: n[r].t || +new Date
                        }, o.contentWindow.postMessage(JSON.stringify({type: "bubble.reviceMsg", data: p}), "*"))
                    }
                }, v = function (e) {
                    s.trigger("ZC.receivemessage", e)
                }, b = function (e) {
                    var t;
                    if ("string" == typeof e.data)try {
                        t = JSON.parse(e.data)
                    ...
                    "expand" == e && o.contentWindow.postMessage(JSON.stringify({type: "bubble.expand"}), "*")
                }, T = function (e) {
                    ...
                    c(window, "message", b), c(window, "storage", T), a.on("core.message", y), s.on("bubble.expand", w)
                }, M = function () {
    ...
    22: [function (e, t, n) {
        var o = {}, r = {}, i = function (e, t) {
            ...
            if (r[e])for (var n = r[e], o = n.length - 1; o >= 0; o--) {
                var i = n[o];
                if (i === t) {
            ...
            if (r[e])for (var n = r[e], o = 0, i = n.length; o < i; o++)n[o] && n[o](t)
        };
        o.on = i, o.trigger = c, o.off = a, t.exports = o
    }, {}],
    23: [function (e, t, n) {
        var o = e("../../../common/util/addEvent.js"), r = function (t) {
            var n, r, i, a, c = e("../../../common/util/cookie.js"), s = e("../fun/event.js"),
                l = e("../config/config.json"), d = document.documentElement ? document.documentElement : document.body,
                u = (window.location.protocol + "//" + window.location.host, {
                ...
                }), m = {MOBILE: 240, PC: 340}, p = {MOBILE: 150, PC: 200}, f = {hide: "none", show: "block"}, g = {
                    ...
                    var e, o, a, c;
                    t.isMobile ? (e = (i - p.MOBILE) / 2, o = (r - m.MOBILE) / 2, a = m.MOBILE, c = p.MOBILE) : (e = (i - p.PC) / 2, o = (r - m.PC) / 2, a = m.PC, c = p.PC), n.style.cssText += h(u.locCssText, [e, o, a, c])
                }, v = function (e, t) {
                    setTimeout(function () {
                        t() && t
                    }, 1e3 * e)
                    ...
                    o(window, "message", function (e) {
                        if (e.origin && e.origin.indexOf(l.domain) >= 0)if (n.style.cssText += h(u.showCssText, [f.hide]), "1" === e.data) s.trigger("inviteSession"); else {
                            var t = c.getCookie("inviteCount") || 0;
                            0 === t && c.setCookie("inviteCount", 0), Number(t) < g.inviteCount && (c.setCookie("inviteCount", ++t), y())
                        }
                    }, !1)
                }, _ = function () {
                    T(), S(), w()
                };
            Number(c.getCookie("inviteCount")) < g.inviteCount && _()
        };
        t.exports = r
    }, {
        "../../../common/util/addEvent.js": 3,
    ...
    24: [function (e, t, n) {
        var o, r = e("../../../common/util/addEvent.js"), i = {}, a = !0,
            c = (location.hostname.indexOf("www") >= 0 ? "www" : "test", {
                iPhone5: {
                    top: 285,
                    "icon-top": 460,
                    "uc-top": 280,
                ...
                iPhone6: {top: 285, "icon-top": 559, "uc-top": 270, "wechat-top": 344},
                iPhone6p: {top: 300, "icon-top": 619, "uc-top": 270, "wechat-top": 344},
                iPhoneSE: {top: 285, "icon-top": 460, "uc-top": 250, "wechat-top": 344},
                other: {top: 285, "icon-top": 560, "uc-top": 250, "wechat-top": 344}
            }), s = !0, l = function () {
                var e = (navigator.userAgent.toLowerCase(), $(window).width()), t = ($(window).height(), ""), n = 0;
                switch (e >= 310 && e <= 320 && (n = 1), e >= 365 && e <= 385 && (n = 2), e >= 404 && e <= 424 && (n = 3), n) {
                    case 1:
                ...
                a = !0, gloabl = n, e.style.width = t.frameWidth + "px", navigator.userAgent.indexOf("UCBrowser") >= 0 ? setTimeout(function () {
                    e.style.top = "", window.scrollTo(0, c[l()]["uc-top"])
                }, 0) : navigator.userAgent.indexOf("Safari") && navigator.userAgent.indexOf("QQBrowser") < 0 && navigator.userAgent.indexOf("MicroMessenger") < 0 ? setTimeout(function () {
    ...
    25: [function (e, t, n) {
        function o(t) {
            var n = e("../config/config.json"), o = navigator.userAgent.indexOf("Mobile") >= 0, r = {}, i = 1,
                a = function () {
                    var e = [];
                    for (var t in r) {
    ...
    26: [function (e, t, n) {
        var o = function () {
            var e = (navigator.userAgent.indexOf("Mobile") >= 0, {
                ...
                for (var i = document.documentElement.getElementsByTagName("head")[0].getElementsByTagName("style"), a = (i || []).length, c = 0; c < a; c++)if (n(i[c], "ZC-STYLE"))return i[c].innerHTML = o, void(t = !1);
                if (t) {
                    var s = document.createElement("style");
                    s.className = "ZC-STYLE", s.innerHTML = o, document.documentElement.getElementsByTagName("head")[0].appendChild(s)
                }
            };
    ...
    27: [function (e, t, n) {
        function o(t, n) {
            var o = e("../../../common/util/promise.js"), r = e("../../../common/util/ajax.js"),
                i = (e("../fun/event.js"), e("../../../common/util/addEvent.js")),
                a = (e("./trace.js"), e("../config/config.json")), c = e("../util/drag.js"),
                s = navigator.userAgent.indexOf("Mobile") >= 0, l = e("../../../common/util/cookie.js"), d = 40, u = 20,
                m = {
                    ...
                    btnLeftStyle: {pc: ";left:{0}px;bottom:{1}px;", mobile: ";left:{0}px;bottom:{1}px;"},
                    btnRightStyle: {pc: ";right:{0}px;bottom:{1}px;", mobile: ";right:{0}px;bottom:{1}px;"},
                    titleLeftStyle: {
                    ...
                    t.dom = e;
                    var n = e.firstChild.childNodes[0], o = s ? "mobile" : "pc", r = document.createElement("style");
                    e.style.cssText = x(p.btnStyle[o], [t.color]);
                    try {
                        switch (+t.margin) {
                            case 2:
                            case 3:
                                e.style.right = "", e.style.cssText += x(p.btnLeftStyle[o], [t.horizontal, t.vertical]), n.style.cssText = x(p.titleLeftStyle[o], ["555556"]);
                                break;
                            case 1:
                            case 4:
                                e.style.left = "", e.style.cssText += x(p.btnRightStyle[o], [t.horizontal, t.vertical]), n.style.cssText = x(p.titleRightStyle[o], ["555556"])
                        }
                    } catch (i) {
                    }
                    if (document.getElementsByTagName("head")[0].appendChild(r), t.title = decodeURIComponent(t.title), n.innerText = t.title, h(e, n, s), window.localStorage) {
                        var a = window.localStorage.getItem("frameStatus");
                        if ("collapse" === a) {
                            var c = l.getCookie("msgCount");
                            if (c && Number(c) > 0) {
                                var d = e.lastChild;
                                c > 9 ? d.style.cssText += "padding-left:5px;padding-right:5px;" : d.style.padding = "1px", d.innerHTML = c
                            }
                        }
                    }
                }, h = function (e, t, n) {
                    n ? c(e) : (i(e, "mouseover", function (e) {
                    ...
                    y().then(function (o) {
                        try {
                            t.wslink = o["wslink.default"], t.isInvite = e.isInvite || o.isInvite, t.uid = o.uid, t.cid = o.cid, t.manTrace = e.manTrace || o.isTraceFlag, t.companyId = o.pid, t.ustatus = 0 === o.ustatus ? "0" : o.ustatus, t.color = e.color || (o.color ? o.color.substr(1, o.length) : "0aced1"), t.margin = e.location || o.margin, t.title = e.title || o.title, t.inviteImgSrc = o.inviteImgSrc || "https://img.sobot.com/default/autoImg.png", e.horizontal && e.horizontal > d ? t.horizontal = e.horizontal : t.horizontal = o.horizontalMargin && o.horizontalMargin > d ? o.horizontalMargin : d, e.vertical && e.vertical > u ? t.vertical = e.vertical : t.vertical = o.verticalMargin && o.verticalMargin > u ? o.verticalMargin : u, t.size = {
                                width: t.size ? t.size.width : t.width || o.frameWidth,
                                height: t.size ? t.size.height : t.height || o.frameHeight
                            }, t.lan = e.lan || (0 == o.lan ? "cn" : "en"), t.firstTimeout = e.firstTimeout || o.firstTimeOut, t.submitBtnTitle = e.submitBtnTitle || o.submitBtnTitle, t.tipTitle = e.tipTitle || o.tipTitle, t.overTimeout = e.overTimeout || o.overTimeOut, t.inviteCount = e.inviteCount || o.inviteCount, 0 == e.invite || 0 == e.invite ? t.invite = e.invite : t.invite = e.invite || o.isCustomInvite, t.visitStartTime = o.visitStartTime, f.themeConf = t, 0 != t.ustatus && (t.invite = !1), n && n()
                        } catch (r) {
                        }
                    })
                }, b = function (e) {
                    if (!f.themeConf)throw"not initialed yet";
                    return f.themeConf[e]
                }, y = function () {
                    var e = new o;
                    if (!t.sysNum)return e;
                    var n = {sysNum: t.sysNum, source: t.source || s ? 4 : 0};
            ...
            return T(), f.get = b, f.setTheme = g, f.initConf = y, f
        }
    ...
    28: [function (e, t, n) {
        function o(t, n) {
            var o = e("../../../common/util/ajax.js"), r = navigator.userAgent.indexOf("Mobile") >= 0,
                i = e("../config/config.json"), a = e("../../../common/util/errorlog.js"),
                c = {iVisitTrail: "//" + i.domain + "/chat/user/visitTrail.action"},
                s = ["preAbstract", "preVisitUrl", "preVisitTitle", "preThumbnail", "preTags"],
                l = ["curAbstract", "curVisitUrl", "curVisitTitle", "curThumbnail", "curTags"], d = {}, u = 0,
                m = function () {
                    if (n) o({url: c.iVisitTrail, dataType: "json", type: "POST", data: d}).success(function (e) {
                    }).fail(function (e) {
                    }); else {
                        var e = [];
                        for (var t in d) {
                            var r = void 0 === d[t] ? "" : d[t];
                    ...
                    for (var e in t) {
                        ...
                        for (var n = 0; n < l.length; n++)l[n] == e && (t.curVisitArgs[e] = t.curVisitArgs[e] || t[e] || "")
                    }
                    f()
                }, f = function () {
                    document && (d.preVisitTitle = t.preVisitArgs.preVisitTitle || "", d.preVisitUrl = t.preVisitArgs.preVisitUrl || encodeURIComponent(document.referrer) || "", d.preAbstract = t.preVisitArgs.preAbstract, d.preThumbnail = t.preVisitArgs.preThumbnail, d.preTags = t.preVisitArgs.preTags, d.curVisitTitle = t.curVisitArgs.curVisitTitle || encodeURIComponent(document.title) || "", d.curVisitUrl = t.curVisitArgs.curVisitUrl || encodeURIComponent(document.URL) || "", d.curAbstract = t.curVisitArgs.curAbstract, d.curThumbnail = t.curVisitArgs.curThumbnail, d.curTags = t.curVisitArgs.curTags, t.searchSource ? d.searchSource = "1" : d.searchSource = "0"), navigator && (d.lang = navigator.language || ""), d.uid = t.uid, d.cid = t.cid, d.ustatus = t.ustatus, d.companyId = t.companyId, d.type = u, d.sendTime = +new Date, d.source = r ? "4" : "0", d.addr = "", m()
                }, g = function () {
                    try {
                        p()
                    } catch (e) {
        ...
        t.exports = o
    }, {"../../../common/util/ajax.js": 4, "../../../common/util/errorlog.js": 7, "../config/config.json": 14}],
    29: [function (e, t, n) {
        function o(e) {
            var t, n = {}, o = getzhiSDKInstance(), l = 0, d = "collapse", u = document.getElementById("zhichiCount"),
                m = function () {
                    i({
                    ...
                    if (d = t, "expand" === t && (l = 0, window.localStorage)) {
                        try {
                            window.localStorage.setItem("unreadcount", l)
                        } catch (n) {
                        }
                    ...
                    try {
                        ...
                        if ("zhichiReceive" == n.name)if (e.customBtn) {
                            for (var r = [], i = 0, a = n.data; i < a.length; i++) {
                                var l = {customName: a[i].aname, content: a[i].content, msgId: a[i].msgId};
                                r.push(l)
                            }
                            "collapse" == d && s.trigger("receivemessage", {data: r})
                        } else if (window.localStorage) {
                            var m = o.getStatus();
                            if ("collapse" === m && u) {
                                var p = +c.getCookie("msgCount") || 0;
                                p += n.data ? n.data.length : 0, p > 0 && (c.setCookie("msgCount", p), u.style.display = "block", p > 9 ? u.style.cssText += "padding-left:5px;padding-right:5px;" : u.style.padding = "1px", u.innerHTML = p > 99 ? "99+" : p)
                            }
                        }
                    } catch (f) {
                    }
                    ...
                    var e = +c.getCookie("msgCount") || 0;
                    if (u)if (l > 0 || e > 0) {
                        u.style.display = "block";
                        var t = l || e;
                        t > 9 ? u.style.cssText += "padding-left:5px;padding-right:5px;" : u.style.padding = "1px", u.innerHTML = t > 99 ? "99+" : t
                    } else u.style.display = "none"
                }, x = function (e, t) {
                    "expand" != d && (l += e, window.localStorage && t, h())
                }, v = function () {
                    r(window, "message", f), s.on("core.framestatuschange", p)
                }, b = function () {
                    if (window.localStorage) {
                        var t = window.localStorage.getItem("unreadcount");
                        t && (l = +t);
                        try {
                            window.localStorage.setItem("unreadcount", l)
                        } catch (n) {
                    ...
                    i({
                        ...
                        l += t.size, h(), e.unreadcount = l, s.trigger("unread.count", l)
                    }).fail(function (e) {
                    })
                }, y = function () {
                    g(), v(), b()
        ...
        var r = e("../../../common/util/addEvent.js"), i = e("../../../common/util/ajax.js"),
            a = e("../config/config.json"), c = e("../../../common/util/cookie.js"), s = e("../fun/event.js");
        t.exports = o
    }, {
        "../../../common/util/addEvent.js": 3,
        "../../../common/util/ajax.js": 4,
    ...
    30: [function (e, t, n) {
        var o = function (t, n) {
            var o, r = ["utm_source", "utm_medium", "utm_term", "utm_content", "utm_campaign"],
                i = e("../config/config.json"), a = {}, c = {}, s = e("../../../common/util/queryParam.js"),
                l = e("../../../common/util/ajax.js"), d = {utm: "/chat/utm.action"}, u = function () {
                    try {
                        c.parentUrl = window.parent.location.href
                    } catch (e) {
                        c.parentUrl = ""
                    }
                    m()
                    ...
                    o = s(c.parentUrl) || {};
                    for (var e in o)if (o.hasOwnProperty(e))for (var i = 0; i < r.length; i++)if (e === r[i])try {
                        a[e] = decodeURIComponent(o[e])
                    } catch (u) {
                        a[e] = ""
                    }
                    c && (c.uid = n.uid, c.sysNum = t.sysNum, l({
                        url: d.utm,
                        data: c,
                        dataType: "json",
                        type: "POST"
        ...
        t.exports = o
    }, {"../../../common/util/ajax.js": 4, "../../../common/util/queryParam.js": 13, "../config/config.json": 14}],
    31: [function (e, t, n) {
        function o(e) {
            var t, n, o = 0, i = 1e4, a = "connecting", c = function () {
                clearTimeout(n)
            }, s = function () {
                t.close()
            }, l = function () {
                ...
                }, t.onclose = c, t.onerror = function () {
                }, t.onopen = function () {
                    var n = {t: o, u: e.userinfo.uid, s: e.sysNum, ts: +new Date};
                    t.send(JSON.stringify(n)), d()
                }
            }, m = function () {
                t = new WebSocket(e.wslink), u()
            };
            m(), this.getStatus = l, this.close = s
        }
    ...
    32: [function (e, t, n) {
        function o(e) {
            var t, n = "connecting", o = function () {
                e.visitId && i({
                    url: "//" + a.domain + "/chat/user/queryVisit.action",
                    type: "get",
                    dataType: "jsonp",
                    data: {visitId: e.visitId}
                }).success(function (e) {
            ...
            l(), this.getStatus = c, this.close = s, this.tnk = +new Date
        }

        var r = e("../../../common/util/listener.js"), i = e("../../../common/util/ajax.js"), a = e("../config/config");
        t.exports = o
    }, {"../../../common/util/ajax.js": 4, "../../../common/util/listener.js": 10, "../config/config": 14}],
    33: [function (e, t, n) {
        var o, r = e("./ZcWebsocket.js"), i = e("./rolling.js"), a = function (e) {
    ...
    }, {"./ZcWebsocket.js": 31, "./rolling.js": 32}],
    34: [function (e, t, n) {
        var o = {};
    ...
    35: [function (e, t, n) {
        var o = function (e) {
            var t, n, o, r, i, a = ("ontouchend" in window ? "touchend" : "click", e), c = document.body.clientWidth,
                s = document.documentElement.clientHeight, l = !1, d = function (e) {
                    ...
                    if (e.preventDefault(), e.stopPropagation(), l) {
                        var t = r + e.touches[0].pageX - n - a.clientWidth, d = c - a.clientWidth;
                        t > d ? t = d : t <= 0 && (t = 0);
                        var u = i + e.touches[0].clientY - o - a.clientHeight, m = s - a.clientHeight;
                        return u > m ? u = m : u <= 0 && (u = 0), a.style.cssText += "left:" + t + "px;top:" + u + "px;", !1
                    }
                }, m = function (e) {
                    a.style.cssText += "transition:all 0.3s ease-in-out 0.1s", a.offsetLeft !== t && (a.offsetTop <= 50 ? (a.style.top = "20px", a.offsetLeft <= 50 ? a.style.left = "20px" : c - a.offsetLeft <= 50 && (a.style.left = c - a.clientWidth - 20 + "px")) : s - a.offsetTop - a.clientWidth <= 50 ? (a.style.top = s - a.clientWidth - 20 + "px", a.offsetLeft <= 50 ? a.style.left = "20px" : c - a.offsetLeft <= 50 && (a.style.left = c - a.clientWidth - 20 + "px")) : c / 2 > a.offsetLeft + a.clientWidth / 2 ? a.style.left = "20px" : a.style.left = c - a.clientWidth - 20 + "px")
                }, p = function () {
                }, f = function () {
    ...
    36: [function (e, t, n) {
        var o = {}, r = e("./tween.js"), i = function (e, t) {
            ...
            for (var a = [], c = 0; c < t.length; c++) {
                ...
                s = +s.replace(/px/, "");
                var d = l - s, u = d > 0;
                a.push({org: s, tar: n[c], dis: d, dir: u})
            }
            var m = 1, p = 50, f = function () {
                if (m < p) {
                    m++;
                    for (var n = 0; n < a.length; n++) {
                        var i = a[n], c = i.dir, s = i.tar, l = i.dis, d = i.org, u = t[n],
                            g = r.Cubic.easeIn(m, 0, Math.abs(l), p), h = d + (c ? 1 : -1) * g;
            ...
            for (var a = [], c = 0; c < t.length; c++) {
                var s = t[c], l = i(e, s);
                l = +l.replace(/px/, "");
                var d = n[c], u = d - l, m = u > 0;
                a.push({tar: d, dis: u, dir: m, org: l})
            }
            var p = 0, f = 50, g = function () {
                if (p < f) {
                    p++;
                    for (var n = 0; n < a.length; n++) {
                        var i = a[n], c = i.tar, l = Math.abs(i.dis), d = i.dir, u = i.org,
                            m = r.Cubic.easeIn(p, 0, l, f), h = u + (d ? 1 : -1) * m;
                        "opacity" !== t[n] && (h = Math.ceil(h)), e.style[t[n]] = h + ("opacity" !== s ? "px" : "")
                    }
                    setTimeout(g, 0)
                } else {
                    for (var n = 0; n < a.length; n++) {
        ...
        o.collapse = a, o.expand = c, o.expandForIframe = l, o.collapseForIframe = s, t.exports = o
    }, {"./tween.js": 37}],
    37: [function (e, t, n) {
        var o = {
